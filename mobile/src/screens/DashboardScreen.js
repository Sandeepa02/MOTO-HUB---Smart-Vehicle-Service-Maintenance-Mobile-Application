...
const actions = [
  ...
  { label: 'Service Bookings', screen: 'Bookings' },
  { label: 'Maintenance Records', screen: 'Maintenance' },
  { label: 'Service Centers', screen: 'ServiceCenters' },
  { label: 'Reviews & Ratings', screen: 'Reviews' },
...
export default function DashboardScreen({ navigation }) {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>Smart Vehicle Service</Text>
